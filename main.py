    ...
    if accepted=="Accepted":
        ...
        if firstname and lastname:
            ...
            table_create_query = '''CREATE TABLE IF NOT EXISTS Student_Data 
                    (firstname TEXT, middlename TEXT, lastname TEXT, title TEXT, age INT, nationality TEXT, 
                    registration_status TEXT, num_courses INT, num_semesters INT)
            '''
            conn.execute(table_create_query)
            
            # Insert Data
            data_insert_query = '''INSERT INTO Student_Data (firstname, middlename, lastname, title, 
            age, nationality, registration_status, num_courses, num_semesters) VALUES 
            (?, ?, ?, ?, ?, ?, ?, ?)'''
            data_insert_tuple = (firstname, middlename, lastname, title,
...
nationality_combobox = ttk.Combobox(user_info_frame, values=["Africa","South America", "North America", "India", "Pakistan","England","Argentina","Brazil","Portugal","Australia","Russia","Iran","Germany","France"])
...
registered_check = tkinter.Checkbutton(courses_frame, text="Registered",
